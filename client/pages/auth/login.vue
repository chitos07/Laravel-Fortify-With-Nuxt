            ...
            <template v-if="verification">
                ...
                <form @submit.prevent="verify">
                    ...
                    <div class="flex flex-col mt-4" v-if="!recovery">
                        ...
                        <input ref="code" id="code" type="text" inputmode="numeric" v-model="recForm.code" autofocus
                            autocomplete="one-time-code" class="px-2 py-1 rounded">
                    </div>

                    <div class="flex flex-col mt-4" v-else>
                        <label class="text-gray-50">Recovery Code</label>
                        <input ref="recovery_code" id="recovery_code" type="text" v-model="recForm.recovery_code"
                            autocomplete="one-time-code" class="px-2 py-1 rounded">
                    </div>

                    <div class="flex flex-col justify-center mt-4">
                        <button type="button"
                            class="text-white border rounded uppercase tracking-wider leading-tight my-4 px-4 py-2"
                            :class="!recovery ? 'bg-green-500 hover:bg-green-800' : 'bg-blue-500 hover:bg-blue-800'"
            ...
            <template v-else>
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="flex justify-around mt-4">
                        <NuxtLink to="/auth/forgotPassword" class="text-white hover:text-blue-300">Forgot Password?
                        </NuxtLink>
