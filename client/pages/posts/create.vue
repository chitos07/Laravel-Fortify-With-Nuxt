          ...
          <main class="container mx-auto">
               <form @submit.prevent="submit" class="bg-red-800 rounded w-3/4 mx-auto px-6 py-6 space-y-6">
                    ...
                    <div class="flex flex-col">
                         ...
                         <textarea cols="30" rows="10" class="border rounded px-2 py-2" v-model="form.body"
                    ...
                    <div class="flex justify-between">
                         <NuxtLink to="/posts"
                              ...
                              Cancel</NuxtLink>
                         <button type="submit"
                              class="bg-blue-500 text-white border rounded uppercase px-2 py-1 tracking-wider leading-tight hover:bg-blue-800">Submit</button>
                    </div>
               </form>
          </main>
     </div>
